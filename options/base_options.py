...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='unetattloss',
        ...
        parser.add_argument('--netD', type=str, default='n_layers',
                            help='specify discriminator architecture [basic | n_layers | pixel|sn]. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='subihd',
        ...
        parser.add_argument('--tr_trd_input_type', type=str, default='skip',
                            help='skip: trd and tre same input, flow: tre output as trd input, skip||flow')
        ...
        parser.add_argument('--tr_r_enc_layers', type=int, default=9, help='tr_r_enc_head')
        parser.add_argument('--tr_r_dec_head', type=int, default=2, help='tr_r_enc_head')
        parser.add_argument('--tr_r_dec_layers', type=int, default=9, help='tr_r_enc_head')
        parser.add_argument('--tr_i_dec_head', type=int, default=2, help='tr_r_enc_head')
        parser.add_argument('--tr_i_dec_layers', type=int, default=9, help='tr_r_enc_head')
        parser.add_argument('--tr_l_enc_head', type=int, default=2, help='tr_r_enc_head')
        parser.add_argument('--tr_l_enc_layers', type=int, default=9, help='tr_r_enc_head')
        ...
        parser.add_argument('--pos_type', type=str, default='sincos', choices=['sincos', 'learn', 'random'],
